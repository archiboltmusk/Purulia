...
window.KASA_I18N = {
  ...
  bn: {
    ...
    hero_cta: 'এখনই রিপোর্ট করুন', nav_more: 'আরও', filters_btn: 'ফিল্টার', hero_how: 'যাচাই কীভাবে হয় ↓',
  ...
  hi: {
    ...
    hero_cta: 'अभी रिपोर्ट करें', nav_more: 'और', filters_btn: 'फ़िल्टर', hero_how: 'पुष्टि कैसे होती है ↓',
