...
window.KASA_I18N = {
  en: {
    ...
    hero_cta: 'Report Now', nav_more: 'More', nav_changelog: "What's new", cam_flash: 'Flash', cam_flash_fail: 'Flash is not available on this camera.', filters_btn: 'Filters', nearby_btn: 'Near me', nearby_permission: 'Allow location access to see reports within 5 km.', nearby_on: 'Showing reports near you', nearby_off: 'Showing all reports', hero_how: 'How verification works ↓',
  ...
  bn: {
    ...
    hero_cta: 'এখনই রিপোর্ট করুন', nav_more: 'আরও', nav_changelog: 'নতুন কী', cam_flash: 'ফ্ল্যাশ', cam_flash_fail: 'এই ক্যামেরায় ফ্ল্যাশ নেই।', filters_btn: 'ফিল্টার', hero_how: 'যাচাই কীভাবে হয় ↓',
  ...
  hi: {
    ...
    hero_cta: 'अभी रिपोर्ट करें', nav_more: 'और', nav_changelog: 'नया क्या है', cam_flash: 'फ़्लैश', cam_flash_fail: 'इस कैमरे में फ़्लैश उपलब्ध नहीं है।', filters_btn: 'फ़िल्टर', hero_how: 'पुष्टि कैसे होती है ↓',
